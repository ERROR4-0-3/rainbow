...
const { chains , provider  } = (0,_rainbow_me_rainbowkit__WEBPACK_IMPORTED_MODULE_1__.configureChains)([
    ...
    wagmi__WEBPACK_IMPORTED_MODULE_2__.chain.optimism,
    wagmi__WEBPACK_IMPORTED_MODULE_2__.chain.arbitrum
], [
    _rainbow_me_rainbowkit__WEBPACK_IMPORTED_MODULE_1__.apiProvider.alchemy(process.env.ALCHEMY_ID),
